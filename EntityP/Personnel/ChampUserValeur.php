...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Personnel\ChampUserValeurRepository")
 */
class ChampUserValeur
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Personnel\ChampsParametrable", inversedBy="champUserValeurs")
