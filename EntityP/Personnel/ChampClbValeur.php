...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Personnel\ChampClbValeurRepository")
 */
class ChampClbValeur
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Personnel\ChampsParametrable", inversedBy="champClbValeurs")
